...
(cljs.tools.reader.impl.utils.ReaderConditional.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k11586,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k11586,else__5346__auto__);
...
return (new cljs.core.RecordIter((0),G__11585__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"splicing?","splicing?",-428596366),new cljs.core.Keyword(null,"form","form",-1624062471)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(cljs.tools.reader.impl.utils.ReaderConditional.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this11587,other11588){
var self__ = this;
var this11587__$1 = this;
return (((!((other11588 == null)))) && ((((this11587__$1.constructor === other11588.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this11587__$1.splicing_QMARK_,other11588.splicing_QMARK_)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this11587__$1.form,other11588.form)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this11587__$1.__extmap,other11588.__extmap)))))))));
}));
...
(cljs.tools.reader.impl.utils.ReaderConditional.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k11586){
var self__ = this;
var this__5350__auto____$1 = this;
var G__11604 = k11586;
var G__11604__$1 = (((G__11604 instanceof cljs.core.Keyword))?G__11604.fqn:null);
switch (G__11604__$1) {
case "splicing?":
case "form":
return true;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k11586);

}
}));

(cljs.tools.reader.impl.utils.ReaderConditional.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__11585){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__11615 = cljs.core.keyword_identical_QMARK_;
var expr__11616 = k__5352__auto__;
if(cljs.core.truth_((pred__11615.cljs$core$IFn$_invoke$arity$2 ? pred__11615.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"splicing?","splicing?",-428596366),expr__11616) : pred__11615.call(null,new cljs.core.Keyword(null,"splicing?","splicing?",-428596366),expr__11616)))){
return (new cljs.tools.reader.impl.utils.ReaderConditional(G__11585,self__.form,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__11615.cljs$core$IFn$_invoke$arity$2 ? pred__11615.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"form","form",-1624062471),expr__11616) : pred__11615.call(null,new cljs.core.Keyword(null,"form","form",-1624062471),expr__11616)))){
...
return (new cljs.tools.reader.impl.utils.ReaderConditional(self__.splicing_QMARK_,self__.form,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__11585),null));
}
}
}));
...
(cljs.tools.reader.impl.utils.ReaderConditional.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__11585){
var self__ = this;
 ...
 */
cljs.tools.reader.impl.utils.map__GT_ReaderConditional = (function cljs$tools$reader$impl$utils$map__GT_ReaderConditional(G__11590){
var extmap__5385__auto__ = (function (){var G__11623 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__11590,new cljs.core.Keyword(null,"splicing?","splicing?",-428596366),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"form","form",-1624062471)], 0));
if(cljs.core.record_QMARK_(G__11590)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__11623);
} else {
return G__11623;
}
})();
return (new cljs.tools.reader.impl.utils.ReaderConditional(new cljs.core.Keyword(null,"splicing?","splicing?",-428596366).cljs$core$IFn$_invoke$arity$1(G__11590),new cljs.core.Keyword(null,"form","form",-1624062471).cljs$core$IFn$_invoke$arity$1(G__11590),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
...
var iter__5523__auto__ = (function cljs$tools$reader$impl$utils$namespace_keys_$_iter__11644(s__11645){
...
var key = cljs.core._nth(c__5521__auto__,i__11646);
cljs.core.chunk_append(b__11647,(((((key instanceof cljs.core.Symbol)) || ((key instanceof cljs.core.Keyword))))?(function (){var vec__11652 = cljs.core.juxt.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace,cljs.core.name)(key);
var key_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11652,(0),null);
var key_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11652,(1),null);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__11647),cljs$tools$reader$impl$utils$namespace_keys_$_iter__11644(cljs.core.chunk_rest(s__11645__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__11647),null);
}
} else {
var key = cljs.core.first(s__11645__$2);
return cljs.core.cons((((((key instanceof cljs.core.Symbol)) || ((key instanceof cljs.core.Keyword))))?(function (){var vec__11658 = cljs.core.juxt.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace,cljs.core.name)(key);
var key_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11658,(0),null);
var key_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11658,(1),null);
var __GT_key = (((key instanceof cljs.core.Symbol))?cljs.core.symbol:cljs.core.keyword);
if((key_ns == null)){
return (__GT_key.cljs$core$IFn$_invoke$arity$2 ? __GT_key.cljs$core$IFn$_invoke$arity$2(ns,key_name) : __GT_key.call(null,ns,key_name));
} else {
...
})():key),cljs$tools$reader$impl$utils$namespace_keys_$_iter__11644(cljs.core.rest(s__11645__$2)));
}
} else {
return null;
}
...
cljs.tools.reader.impl.utils.second_SINGLEQUOTE_ = (function cljs$tools$reader$impl$utils$second_SINGLEQUOTE_(p__11667){
var vec__11668 = p__11667;
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11668,(0),null);
var b = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11668,(1),null);
