...
return abakus.rn.storage.getItem("props").then((function (p1__23466_SHARP_){
...
}),cljs.reader.read_string.cljs$core$IFn$_invoke$arity$1(p1__23466_SHARP_))], null));
}));
});
...
return abakus.rn.storage.getItem("uid").then((function (p1__23467_SHARP_){
if((!((p1__23467_SHARP_ == null)))){
return abakus.core.set_app_uid(p1__23467_SHARP_);
} else {
