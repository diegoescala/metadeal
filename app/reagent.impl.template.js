...
var G__15211 = o;
reagent.impl.template.goog$module$goog$object.set(G__15211,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__15332__i < G__15332__a.length) {G__15332__a[G__15332__i] = arguments[G__15332__i + 0]; ++G__15332__i;}
  args = new cljs.core.IndexedSeq(G__15332__a,0,null);
} 
return G__15329__delegate.call(this,args);};
G__15329.cljs$lang$maxFixedArity = 0;
G__15329.cljs$lang$applyTo = (function (arglist__15333){
...
var G__15212 = o;
reagent.impl.template.goog$module$goog$object.set(G__15212,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__15338__i < G__15338__a.length) {G__15338__a[G__15338__i] = arguments[G__15338__i + 0]; ++G__15338__i;}
  args = new cljs.core.IndexedSeq(G__15338__a,0,null);
} 
...
var G__15213 = props;
var G__15213__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__15213,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__15213);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__15213__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__15214 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__15214,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__15214;
}
})(),id_class);
...
var G__15215 = (cljs.core.count(argv) - first_child);
switch (G__15215) {
case (0):
...
var vec__15218 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15218,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15218,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15218,(2),null);
...
var temp__5808__auto___15360 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___15360 == null)){
} else {
var key_15361 = temp__5808__auto___15360;
(jsprops.key = key_15361);
}
...
var temp__5808__auto___15367 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___15367 == null)){
} else {
var key_15368 = temp__5808__auto___15367;
(jsprops.key = key_15368);
}
...
var temp__5808__auto___15379 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___15379 == null)){
} else {
var key_15380 = temp__5808__auto___15379;
(jsprops.key = key_15380);
}
...
var temp__5808__auto___15395 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___15395 == null)){
} else {
var key_15396 = temp__5808__auto___15395;
(jsprops.key = key_15396);
}
...
var temp__5808__auto___15400 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___15400 == null)){
} else {
var key_15401 = temp__5808__auto___15400;
(jsprops.key = key_15401);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__15274_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__15274_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__15284 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15284,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15284,(1),null);
...
break;
default:
var G__15412 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__15413 = compiler;
v = G__15412;
compiler = G__15413;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template15316 = (function (opts,id,fn_to_element,parse_fn,meta15317){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template15316.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_15318,meta15317__$1){
var self__ = this;
var _15318__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template15316(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta15317__$1));
}));

(reagent.impl.template.t_reagent$impl$template15316.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_15318){
var self__ = this;
var _15318__$1 = this;
return self__.meta15317;
}));

(reagent.impl.template.t_reagent$impl$template15316.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template15316.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template15316.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template15316.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template15316.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template15316.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta15317","meta15317",1323232055,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template15316.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template15316.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template15316");

(reagent.impl.template.t_reagent$impl$template15316.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template15316");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template15316.
 */
reagent.impl.template.__GT_t_reagent$impl$template15316 = (function reagent$impl$template$__GT_t_reagent$impl$template15316(opts,id,fn_to_element,parse_fn,meta15317){
return (new reagent.impl.template.t_reagent$impl$template15316(opts,id,fn_to_element,parse_fn,meta15317));
});
...
return (new reagent.impl.template.t_reagent$impl$template15316(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
