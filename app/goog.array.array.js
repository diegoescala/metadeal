goog.loadModule(function(exports) {
  ...
  function bucket(array, sorter, opt_obj) {
    ...
    for (var i = 0; i < array.length; i++) {
      ...
      if (key !== undefined) {
        var bucket$9 = buckets[key] || (buckets[key] = []);
        bucket$9.push(value);
      }
    }
    return buckets;
  ...
  function bucketToMap(array, sorter) {
    ...
    for (var i = 0; i < array.length; i++) {
      ...
      if (key !== undefined) {
        var bucket$10 = buckets.get(key);
        if (!bucket$10) {
          bucket$10 = [];
          buckets.set(key, bucket$10);
        }
        bucket$10.push(value);
      }
    }
    return buckets;
  }
  ...
  function range(startOrEnd, opt_end, opt_step) {
    ...
    if (step > 0) {
      ...
      for (var i$11 = start; i$11 > end; i$11 += step) {
        array.push(i$11);
      }
    }
    return array;
  ...
  function zip(var_args) {
    ...
    for (var i$12 = 0; i$12 < minLen; i$12++) {
      var value = [];
      for (var j = 0; j < arguments.length; j++) {
        value.push(arguments[j][i$12]);
      }
      result.push(value);
    }
    return result;
