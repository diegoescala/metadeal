...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [abakus.rn.view,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),abakus.styles.navbar_container], null),(function (){var iter__5523__auto__ = (function abakus$navbar$navbar_$_iter__21436(s__21437){
return (new cljs.core.LazySeq(null,(function (){
var s__21437__$1 = s__21437;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__21437__$1);
if(temp__5804__auto__){
var s__21437__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__21437__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__21437__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__21439 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__21438 = (0);
while(true){
if((i__21438 < size__5522__auto__)){
var page = cljs.core._nth(c__5521__auto__,i__21438);
cljs.core.chunk_append(b__21439,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [abakus.navbar.page_option,page], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),page], null)));

var G__21454 = (i__21438 + (1));
i__21438 = G__21454;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__21439),abakus$navbar$navbar_$_iter__21436(cljs.core.chunk_rest(s__21437__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__21439),null);
}
} else {
var page = cljs.core.first(s__21437__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [abakus.navbar.page_option,page], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),page], null)),abakus$navbar$navbar_$_iter__21436(cljs.core.rest(s__21437__$2)));
}
} else {
return null;
}
