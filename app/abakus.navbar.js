...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [abakus.rn.view,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),abakus.styles.navbar_container], null),(function (){var iter__5523__auto__ = (function abakus$navbar$navbar_$_iter__13474(s__13475){
...
var c__5521__auto__ = cljs.core.chunk_first(s__13475__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__13477 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__13476 = (0);
while(true){
if((i__13476 < size__5522__auto__)){
var page = cljs.core._nth(c__5521__auto__,i__13476);
cljs.core.chunk_append(b__13477,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [abakus.navbar.page_option,page], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),page], null)));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__13477),abakus$navbar$navbar_$_iter__13474(cljs.core.chunk_rest(s__13475__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__13477),null);
}
} else {
var page = cljs.core.first(s__13475__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [abakus.navbar.page_option,page], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),page], null)),abakus$navbar$navbar_$_iter__13474(cljs.core.rest(s__13475__$2)));
}
} else {
return null;
}
