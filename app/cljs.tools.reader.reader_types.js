...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_18885 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_18885(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_18892 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_18892(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_18902 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_18902(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_18903 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_18903(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_18914 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_18914(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_18916 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_18916(reader);
}
});
...
var G__18936 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__18937 = s.append(c);
c = G__18936;
s = G__18937;
continue;
}
