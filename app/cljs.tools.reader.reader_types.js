...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_12053 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_12053(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_12059 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_12059(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_12064 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_12064(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_12070 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_12070(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_12075 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_12075(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_12085 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_12085(reader);
}
});
...
var G__12131 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__12132 = s.append(c);
c = G__12131;
s = G__12132;
continue;
}
