...
var empties = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__13483_SHARP_){
return (((!(abakus.reports.number_string_QMARK_(cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.get.cljs$core$IFn$_invoke$arity$2(m,p1__13483_SHARP_)))))) || (cljs.core.empty_QMARK_(cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.get.cljs$core$IFn$_invoke$arity$2(m,p1__13483_SHARP_)))));
}),cljs.core.keys(m));
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__13484_SHARP_,p2__13485_SHARP_){
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(p1__13484_SHARP_,p2__13485_SHARP_);
}),m,empties);
});
...
var len__5769__auto___13514 = arguments.length;
var i__5770__auto___13515 = (0);
while(true){
if((i__5770__auto___13515 < len__5769__auto___13514)){
args__5775__auto__.push((arguments[i__5770__auto___13515]));

var G__13516 = (i__5770__auto___13515 + (1));
i__5770__auto___13515 = G__13516;
continue;
} else {
}
break;
...
/** @this {Function} */
(abakus.reports.average.cljs$lang$applyTo = (function (seq13487){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq13487));
}));
...
var G__13491 = abakus.reports.recompute(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(prop,independent_var,p1__13488_SHARP_));
return (dependent_var.cljs$core$IFn$_invoke$arity$1 ? dependent_var.cljs$core$IFn$_invoke$arity$1(G__13491) : dependent_var.call(null,G__13491));
...
var G__13517 = left;
var G__13518 = abakus.reports.average.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([left,mid], 0));
var G__13519 = mid;
var G__13520 = (steps + (1));
left = G__13517;
mid = G__13518;
right = G__13519;
steps = G__13520;
...
var G__13521 = mid;
var G__13522 = abakus.reports.average.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([mid,right], 0));
var G__13523 = right;
var G__13524 = (steps + (1));
left = G__13521;
mid = G__13522;
right = G__13523;
steps = G__13524;
...
var prop = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.deref(re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"prop-info","prop-info",-1596130956)], null))),independent_var,(function (){var G__13506 = abakus.reports.recompute(cljs.core.deref(re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"prop-info","prop-info",-1596130956)], null))));
return (independent_var.cljs$core$IFn$_invoke$arity$1 ? independent_var.cljs$core$IFn$_invoke$arity$1(G__13506) : independent_var.call(null,G__13506));
})());
var steps = (5);
var span = 1.0;
...
var points = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__13492_SHARP_){
return ((1.0 + ((p1__13492_SHARP_ / (steps - (1))) - (0.5 * span))) * current_val);
}),cljs.core.range.cljs$core$IFn$_invoke$arity$1(steps));
var values = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__13493_SHARP_,p2__13494_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__13493_SHARP_,abakus.reports.recompute(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(prop,independent_var,p2__13494_SHARP_)));
}),cljs.core.PersistentVector.EMPTY,points);
var labels = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__13495_SHARP_){
return abakus.number_utils.localize((p1__13495_SHARP_ | (0)));
}),points);
var data = cljs.core.clj__GT_js(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"labels","labels",-626734591),labels,new cljs.core.Keyword(null,"datasets","datasets",1896364419),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"data","data",-232669377),(function (){var G__13507 = cljs.core.map.cljs$core$IFn$_invoke$arity$2(dependent_var,values);
if(cljs.core.contains_QMARK_(options,new cljs.core.Keyword(null,"percent","percent",2031453817))){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__13496_SHARP_){
return (100.0 * p1__13496_SHARP_);
}),G__13507);
} else {
return G__13507;
}
...
/** @this {Function} */
(abakus.reports.chart.cljs$lang$applyTo = (function (seq13497){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13498,G__13499,G__13500,seq13497__$3);
}));
...
/** @this {Function} */
(abakus.reports.summary_section.cljs$lang$applyTo = (function (seq13509){
...
var G__13512 = cljs.core.first(seq13509__$2);
var seq13509__$3 = cljs.core.next(seq13509__$2);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13510,G__13511,G__13512,seq13509__$3);
}));
