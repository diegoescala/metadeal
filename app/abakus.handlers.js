...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword(null,"set-greeting","set-greeting",-653540063),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [abakus.handlers.validate_spec], null),(function (db,p__23442){
var vec__23443 = p__23442;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23443,(0),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23443,(1),null);
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(db,new cljs.core.Keyword(null,"greeting","greeting",462222107),value);
}));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"set-current-page","set-current-page",-1047328569),(function (db,p__23446){
var vec__23447 = p__23446;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23447,(0),null);
var page = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23447,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"set-prop-info","set-prop-info",1228639413),(function (db,p__23450){
var vec__23451 = p__23450;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23451,(0),null);
var prop = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23451,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"set-properties","set-properties",253591533),(function (db,p__23454){
var vec__23455 = p__23454;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23455,(0),null);
var props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23455,(1),null);
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(db,new cljs.core.Keyword(null,"properties","properties",685819552),props);
}));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"set-uid","set-uid",1006200985),(function (db,p__23458){
var vec__23459 = p__23458;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23459,(0),null);
var uid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23459,(1),null);
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(db,new cljs.core.Keyword(null,"uid","uid",-1447769400),uid);
}));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"set-can-track","set-can-track",-1622191944),(function (db,p__23462){
var vec__23463 = p__23462;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23463,(0),null);
var can_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23463,(1),null);
